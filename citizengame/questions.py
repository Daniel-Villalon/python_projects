...
citizenship_questions = {
    ...
    "What did the Declaration of Independence do?": ["announced our independence", "declared our independence (from Great Britain)", "said that the United States is free"],
    ...
    "Name one war fought by the United States in the 1900s.*": ["World War I", "World War II", "Korean War", "(Persian) Gulf War"],
    ...
    "Where is the Statue of Liberty?*": ["New York", "Liberty Island", "Also acceptable are New Jersey, near New York City, and on the Hudson (River)."],
